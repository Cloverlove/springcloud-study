 ...
 *
 * @author Huxudong
 * @date   2019-09-09 19:54:45
 **/
@RestController
public class DeptController8001 {
     ...
     * @throws Exception
     **/
    @ApiOperation(value = "DEPT-ADD-8001",notes = "dpt-8001微服务新增一条部门的信息")
    @ApiImplicitParams({
     ...
     * @throws Exception
     **/
    @ApiOperation(value = "DEPT-FINDBYID-8001",notes = "根据部门id查询部门信息")
    @ApiImplicitParams({
     ...
     * @throws Exception
     **/
    @ApiOperation(value = "DEPT-FINDALL-8001",notes = "根据部门id查询部门信息")
    @ApiImplicitParams({
