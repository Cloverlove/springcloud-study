 ...
 */
@RestController
public class DeptController8003 {
     ...
     * @throws Exception
     **/
    @ApiOperation(value = "DEPT-ADD-8003",notes = "dpt-8001微服务新增一条部门的信息")
    @ApiImplicitParams({
     ...
     * @throws Exception
     **/
    @ApiOperation(value = "DEPT-FINDBYID-8003",notes = "根据部门id查询部门信息")
    @ApiImplicitParams({
     ...
     * @throws Exception
     **/
    @ApiOperation(value = "DEPT-FINDALL-8003",notes = "根据部门id查询部门信息")
    @ApiImplicitParams({
